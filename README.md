...
```
# When running on Hiperlab server.
...
> funsearch run examples_ng/inv_pendulum_spec.py 0.6 --sandbox_type ExternalProcessSandbox

# Difference cache folder. Not sure why i did it.
docker run --gpus all -it -v $(pwd):/workspace/data -v /home/$USER/ssd_data/_huggingface_cache:/root/.cache/huggingface funsearch

# When running on OUR machine, so I can use the small model.
...
# [carlo] launch torch experiment from server (shared cache for models)
docker run --gpus all -it -v /home/cbosio/fun-design/data:/workspace/data -v /home/cbosio/.cache/huggingface:/root/.cache/huggingface funsearch
